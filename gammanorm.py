...
def getespec(emin=3, emax=10):
    ...
    put_plot_on_axis(figax=figax1, xlabel=r'$E$ (MeV)', xlim=(E[0], E[-1]), saveas='gammanorm',
        data = [
            [
                E, I[0] / I[1],
    ...
    put_plot_on_axis(figax=figax2, xlabel=r'$E$ (MeV)', xlim=(E[0], E[-1]), saveas='gammanorm_pi0_gam',
        data = [
